...
alias clc='npx --yes --package @anthropic-ai/claude-code@latest claude'
...
alias g='git'
alias ga='git add'
alias gacp='git add -A && curl -s https://commit.jaw.dev/ | bash -s -- --no-verify && git push'
...
alias gdd='git diff-plain'
alias gddc='git diff-plain --cached'
alias gl='git pull'
alias gp='git push'
alias gs='git status'
