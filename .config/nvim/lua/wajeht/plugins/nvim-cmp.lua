return {
  ...
  config = function()
    ...
    vim.cmd([[
      highlight NormalFloat guifg=#333333 guibg=NONE ctermbg=NONE
      highlight FloatBorder guifg=#333333 guibg=NONE ctermbg=NONE
      highlight CmpBorder guifg=#333333 guibg=NONE ctermbg=NONE
    ]])
  end,
}
