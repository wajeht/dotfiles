return {
  ...
  config = function()
    ...
    vim.cmd([[
      highlight NormalFloat guifg=#2d4f56 guibg=NONE ctermbg=NONE
      highlight FloatBorder guifg=#2d4f56 guibg=NONE ctermbg=NONE
      highlight CmpBorder guifg=#2d4f56 guibg=NONE ctermbg=NONE
    ]])
  end,
}
