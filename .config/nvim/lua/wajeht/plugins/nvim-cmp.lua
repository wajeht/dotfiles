return {
  ...
  config = function()
    ...
    vim.cmd([[
      highlight NormalFloat guifg=#2b4046 guibg=#121c1e ctermbg=NONE
      highlight FloatBorder guifg=#2b4046 guibg=#121c1e ctermbg=NONE
      highlight CmpBorder guifg=#2b4046 guibg=#121c1e ctermbg=NONE
    ]])
  end,
}
