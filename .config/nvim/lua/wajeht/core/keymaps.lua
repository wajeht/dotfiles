...
vim.keymap.set("n", "<D-a>", "ggVGi", { desc = "Select all and go to insert mode" }) -- Cmd+a to select all text and enter insert mode
vim.keymap.set("i", "<D-a>", "<Esc>ggVGi", { desc = "Select all and go to insert mode" }) -- Cmd+a to select all text and enter insert mode
vim.keymap.set("v", "<D-a>", "<Esc>ggVGi", { desc = "Select all and go to insert mode" }) -- Cmd+a to select all text and enter insert mode
